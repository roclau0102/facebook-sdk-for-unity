...
# dy
UNITY_JAR_RESOLVER_BASE_URL_DY="http://opensource.oa.com/unity_public/$UNITY_JAR_RESOLVER_NAME/repository/archive.zip?ref=v"
UNITY_JAR_RESOLVER_ZIP_URL_DY="$UNITY_JAR_RESOLVER_BASE_URL_DY$UNITY_JAR_RESOLVER_VERSION"
...
downloadUnityJarResolverFromGithub() {
  ...
  curl -L "$UNITY_JAR_RESOLVER_ZIP_URL_DY" > $UNITY_JAR_RESOLVER_NAME.zip || die "Failed to download $UNITY_JAR_RESOLVER_URL"
